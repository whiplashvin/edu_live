  ...
  return (
    <div className="p-2">
      <div className="flex gap-4 items-center justify-end">
        <button
          className={`px-2 py-1 rounded bg-indigo-500 text-zinc-50 hover:scale-105 font-thin text-[10px] ${action === "draw" && "ring-1 ring-offset-2"}`}
          onClick={() => {
            setAction("draw");
            setColor("#343a40");
            setStrokeWidth(7);
        ...
        <button
          className={`px-2 py-1 rounded bg-indigo-500 text-zinc-50 hover:scale-105 font-thin text-[10px] ${action === "erase" && "ring-1 ring-offset-2"}`}
          onClick={() => {
            setColor("#f5faff");
            setAction("erase");
            setStrokeWidth(14);
        ...
        <button
          className="px-2 py-1 rounded bg-indigo-500 hover:scale-105 text-zinc-50 font-thin text-[10px]"
          onClick={() => {
