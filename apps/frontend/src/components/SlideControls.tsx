  ...
  return (
    <div className="p-2 flex justify-between gap-2">
      <div className="flex gap-4 items-center">
        <GrPrevious
          className="p-2  text-indigo-200 text-3xl hover:bg-neutral-600 hover:text-indigo-300 rounded-full"
          onClick={prevPage}
        />
        <GrNext
          className="p-2  text-indigo-200 text-3xl hover:bg-neutral-600 hover:text-indigo-300 rounded-full"
      ...
      <div className="flex gap-4 items-center">
        <button className="px-2 py-1 rounded bg-indigo-200 text-neutral-30 hover:scale-105 text-zinc-900 font-thin text-[10px]">
          annotate
        </button>
